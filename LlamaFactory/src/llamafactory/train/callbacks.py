...
class LogCallback(TrainerCallback):
    ...
    def on_log(self, args: "TrainingArguments", state: "TrainerState", control: "TrainerControl", **kwargs):
        ...
        logs = dict(
            ...
            objective_loss=state.log_history[-1].get("objective_loss"),
            loss_w_gas=state.log_history[-1].get("loss_w_gas"),
            neg_student_nll_loss=state.log_history[-1].get("neg_student_nll_loss"),
            ce_loss=state.log_history[-1].get("ce_loss"),
            hpd_loss=state.log_history[-1].get("hpd_loss"),
            todi_loss=state.log_history[-1].get("todi_loss"),
            todi_total_loss=state.log_history[-1].get("todi_total_loss"),
