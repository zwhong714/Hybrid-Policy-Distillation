...
from ..trainer_utils import create_modelcard_and_push, create_ref_model, patch_deepspeed_count_used_parameters
...
def run_sft(
    ...
    if training_args.deepspeed is not None:
        patch_deepspeed_count_used_parameters()
    ...
    ref_model = None
    if (
        finetuning_args.use_asft_loss
        or finetuning_args.use_hpd_loss
    ...
    if model_args.use_kt:
        ...
        elif finetuning_args.use_hpd_loss:
            raise NotImplementedError("`use_hpd_loss` is not supported in KTransformers SFT yet.")
        elif finetuning_args.use_akl_loss:
            raise NotImplementedError("`use_akl_loss` is not supported in KTransformers SFT yet.")
        elif finetuning_args.use_abkl_loss:
            raise NotImplementedError("`use_abkl_loss` is not supported in KTransformers SFT yet.")
        elif finetuning_args.use_todi_loss:
            raise NotImplementedError("`use_todi_loss` is not supported in KTransformers SFT yet.")
